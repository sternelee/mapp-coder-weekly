...
var Index = (_temp2 = _class = function (_BaseComponent) {
  ...
  function Index() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Index.__proto__ || Object.getPrototypeOf(Index)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["anonymousState__temp", "anonymousState__temp2", "$compid__40", "img", "md", "cTitle", "title", "top", "url", "weeklyStore"], _this.config = {
      ...
      if (len > 1) {
        ...
        _taroWeapp2.default.navigateTo({
          url: '/pages/index/index?cid=' + _this.props.weeklyStore.cid
        });
      }
  ...
  _createClass(Index, [{
    ...
    value: function () {
      var _ref2 = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee() {
        ...
        var weeklyStore, query, cid, cids, tab, data, url, content;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 4:
                ...
                _context.next = 14;
                return this.props.weeklyStore.getPost(query.id);
              ...
              case 14:
                ...
                _taroWeapp2.default.showToast({
                  ...
                  _taroWeapp2.default.setClipboardData({
                    data: _this2.props.weeklyStore.targetPost,
                    success: function success() {
                      _taroWeapp2.default.showToast({
                        title: '原文链接已复制',
                        duration: 1000
              ...
              case 20:
                content = (0, _index.fixUrl)(data.content, url);
    ...
    value: function _createData() {
      ...
      var _state = this.__state,
          ...
          top = _state.top,
          img = _state.img;
      var _props$weeklyStore = this.__props.weeklyStore,
          categorys = _props$weeklyStore.categorys,
          cTitle = _props$weeklyStore.cTitle,
          tab = _props$weeklyStore.tab;

      var issue = categorys.length ? categorys[tab] : { title: '', color: '' };
      var mainColor = issue.color;
      var anonymousState__temp = (0, _taroWeapp.internal_inline_style)({ background: mainColor, padding: top + "px 0 0 10px", height: "35px" });
      var anonymousState__temp2 = (0, _taroWeapp.internal_inline_style)({ padding: '10px', background: mainColor });
...
/***/ "./node_modules/file-loader/dist/cjs.js?name=[path][name].wxml&context=D:\\www\\mapp-coder-weekly\\src!./node_modules/@tarojs/mini-runner/dist/loaders/miniTemplateLoader.js!./node_modules/@tarojs/mini-runner/dist/loaders/wxTransformerLoader.js?!./src/pages/post/index.tsx?taro&type=template&parse=PAGE&":
/*!***************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/file-loader/dist/cjs.js?name=[path][name].wxml&context=D:/www/mapp-coder-weekly/src!./node_modules/@tarojs/mini-runner/dist/loaders/miniTemplateLoader.js!./node_modules/@tarojs/mini-runner/dist/loaders/wxTransformerLoader.js??ref--6-0!./src/pages/post/index.tsx?taro&type=template&parse=PAGE& ***!
  \***************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
},[["./src/pages/post/index.tsx","runtime","vendors"]]]);